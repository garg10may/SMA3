...
Small personal Next.js app that turns a topic or short brief into an X-compatible post using OpenAI.
...
- The route uses the OpenAI Responses API and trims the result to stay within 280 characters.
